...
#
#     PHX_SERVER=true bin/questionnaire_copilot start
#
...
if config_env() == :prod do
  ...
  config :questionnaire_copilot, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :questionnaire_copilot, QuestionnaireCopilot.Mailer,
